...
master_var_init () {
	...
	REF_ISO_PROFILE_REPO_GIT_URL="https://gitlab.com/kalilinux/build-scripts/live-build-config"
	...
	##https://gitlab.com/kalilinux/build-scripts/live-build-config/-/blob/master/auto/config?ref_type=heads
	DEFAULT_PACKAGE_REPO_URL="http://http.kali.org/kali"
	...
	REF_BUILD_LIVE_CONFIG_ROOT_DIR_NAME="kali-config"
...
kali_target_os_mount_for_chroot () {
...
kali_target_os_unmount_for_chroot () {
...
##
## ## Kali / Build ISO / Package Required For Build
##

kali_build_iso_package_required () {
...
##
## ## Kali / Build ISO / Steps
##

kali_build_iso_develop_test () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Run / kali_build_iso_develop_test"
	util_error_echo "##"
	util_error_echo

	msg_master_args

	kali_build_iso_develop_test_prototype
...
kali_build_iso_develop_test_prototype () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Run / kali_build_iso_develop_test_prototype"
	util_error_echo "##"
	util_error_echo
	...
	#kali_build_iso_create

	#kali_build_iso_overlay
...
kali_build_iso_steps () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Run / kali_build_iso_steps"
	util_error_echo "##"
	util_error_echo
...
##
## ## Kali / Build ISO / Prepare
##

kali_build_iso_prepare () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Build ISO / Prepare"
	util_error_echo "##"
	util_error_echo


	kali_build_iso_prepare_work_dir
	kali_build_iso_prepare_iso_profile
...
##
## ## Kali / Build ISO / Prepare / Work Dir
##
...
##
## ## Kali / Build ISO / Prepare / ISO Profile
##
...
kali_build_iso_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Build ISO / Overlay"
	util_error_echo "##"
	util_error_echo

	kali_factory_master_os_file_overlay

	kali_master_os_file_overlay

	kali_master_os_package_overlay

	kali_live_build_config_hook_overlay
...
##
## ## Kali / Master OS / Factory Overlay
##
...
kali_factory_master_os_file_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Master OS / Factory Overlay"
	util_error_echo "##"
	util_error_echo
...
kali_master_os_file_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Master OS / Overlay"
	util_error_echo "##"
	util_error_echo
...
kali_master_os_package_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Master OS / Package"
	util_error_echo "##"
	util_error_echo
...
kali_live_build_config_hook_overlay () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Master OS / Hook"
	util_error_echo "##"
	util_error_echo
...
##
## ## Kali / Build ISO / Archive
##

kali_build_iso_archive () {


	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Build ISO / Archive / Start"
	util_error_echo "##"
	util_error_echo
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Build ISO / Archive / Done"
	util_error_echo "##"
	util_error_echo
...
kali_build_iso_create () {
	...
	util_error_echo
	util_error_echo "##"
	util_error_echo "## ## Kali / Build ISO / Create"
	util_error_echo "##"
	util_error_echo
...
##
## ## Kali / Build ISO / Start
##

kali_build_iso_start () {
